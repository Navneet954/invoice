...
(function (e) {
  ...
  var i = e.fn.dataTable,
    ...
    n = function (a, b) {
      ...
      this.c = e.extend(!0, {}, n.defaults, b);
  ...
  e.extend(n.prototype, {
    ...
    add: function (a, b) {
      ...
      if ("string" === typeof b) {
        for (
          var d = b.split("-"), e = this.s, c = 0, f = d.length - 1;
          c < f;
          c++
        )
          e = e.buttons[1 * d[c]];
    ...
    text: function (a, b) {
      var c = this._nodeToButton(a),
        ...
        f = e(c.node),
        h = function (a) {
          return "function" === typeof a ? a(g, f, c.conf) : a;
        };
    ...
    _expandButton: function (a, b, c, d) {
      for (
        ...
        var l = this._resolveExtends(b[h]);
        if (l)
          if (Array.isArray(l)) this._expandButton(a, l, c, d);
          else {
            var j = this._buildButton(l, c);
            j &&
              (d !== m && null !== d ? (a.splice(d, 0, j), d++) : a.push(j),
              j.conf.buttons &&
                ((j.collection = e("<" + this.c.dom.collection.tag + "/>")),
                (j.conf._collection = j.collection),
                this._expandButton(j.buttons, j.conf.buttons, !0, d)),
              l.init && l.init.call(g.button(j.node), g, e(j.node), l),
              f++);
          }
      }
    },
    _buildButton: function (a, b) {
      var c = this.c.dom.button,
        ...
        f = this.s.dt,
        h = function (b) {
          return "function" === typeof b ? b(f, j, a) : b;
        };
      ...
      var k = function (a, b, c, d) {
        ...
        g = a.tag || c.tag,
        l = a.clickBlurs === m ? !0 : a.clickBlurs,
        j = e("<" + g + "/>")
      ...
      d.tag
        ? ((g = e("<" + d.tag + "/>")
          ...
          "a" === d.tag.toLowerCase() && g.attr("href", "#"),
          j.append(g))
        : j.html(h(a.text));
      ...
      a.namespace || (a.namespace = ".dt-button-" + D++);
      d =
          ...
          for (var g = 0, f = d.length; g < f; g++) {
            ...
            if (h.key)
              if (h.key === a) (b._buttonsHandled = !0), e(k).click();
                ...
                e.isPlainObject(h.key) &&
                h.key.key === a &&
                (!h.key.shiftKey || b.shiftKey)
              )
                if (!h.key.altKey || b.altKey)
                  if (!h.key.ctrlKey || b.ctrlKey)
                    if (!h.key.metaKey || b.metaKey)
    ...
    _popover: function (a, b, c) {
      var d = this.c,
        ...
        f = b.node(),
        h = function () {
          x(e(".dt-button-collection"), g.fade, function () {
            e(this).detach();
          });
          e(
      ...
      f.parents("body")[0] !== q.body && (f = q.body.lastChild);
      g.collectionTitle &&
        c.prepend(
      ...
      w(c.insertAfter(f), g.fade);
      var d = e(b.table().container()),
        k = c.css("position");
      "dt-container" === g.align &&
        ((f = f.parent()), c.css("width", d.width()));
      if (
        "absolute" === k &&
        (c.hasClass(g.rightAlignClassName) ||
          c.hasClass(g.leftAlignClassName) ||
          "dt-container" === g.align)
      ) {
        var l = f.position();
        c.css({ top: l.top + f.outerHeight(), left: l.left });
        var j = c.outerHeight(),
          i = d.offset().top + d.height(),
          t = l.top + f.outerHeight() + j,
          i = t - i,
          t = l.top - j,
          m = d.offset().top,
          u = l.top - j - 5;
        (i > m - t || g.dropup) && -u < m && c.css("top", u);
        var l = d.offset().left,
          d = d.width(),
          d = l + d,
          k = c.offset().left,
        ...
        c.hasClass(g.rightAlignClassName)
          ? ((o = p - s),
            l > k + o &&
              ((k = l - (k + o)), (d -= s + o), (o = k > d ? o + d : o + k)))
          : ((o = l - k),
            d < s + o &&
              ((k = l - (k + o)), (d -= s + o), (o = k > d ? o + d : o + k)));
        c.css("left", c.position().left + o);
      } else
        "absolute" === k
          ? ((l = f.position()),
            c.css({ top: l.top + f.outerHeight(), left: l.left }),
            ...
            (m = d.offset().top),
            (i > m - t || g.dropup) && -u < m && c.css("top", u),
            (o = "button-right" === g.align ? p - s : o - k),
            c.css("left", c.position().left + o))
          : ((k = c.height() / 2),
            k > e(r).height() / 2 && (k = e(r).height() / 2),
            c.css("marginTop", -1 * k));
      ...
      e("body")
        .on("click.dtb-collection", function (b) {
          ...
          ((!e(b.target).parents()[c]().filter(a).length &&
            !e(d).hasClass("dt-buttons")) ||
            e(b.target).hasClass("dt-button-background")) &&
            h();
        })
  ...
  n.background = function (a, b, c, d) {
    c === m && (c = 400);
    d || (d = q.body);
    a
      ? w(e("<div/>").addClass(b).css("display", "none").insertAfter(d), c)
      : x(e("div." + b), c, function () {
  ...
  n.instanceSelector = function (a, b) {
    ...
    var c = [],
      ...
      g = function (a) {
        if (Array.isArray(a)) for (var h = 0, k = a.length; h < k; h++) g(a[h]);
        else
          "string" === typeof a
            ? -1 !== a.indexOf(",")
              ? g(a.split(","))
              : ((a = e.inArray(a.trim(), d)), -1 !== a && c.push(b[a].inst))
      ...
      var c = [],
        d = function (a, b, c) {
          for (var e, g, f = 0, h = b.length; f < h; f++)
            if ((e = b[f]))
              (g = c !== m ? c + f : f + ""),
                a.push({ node: e.node, name: e.conf.name, idx: g }),
                e.buttons && d(a, e.buttons, g + "-");
        },
        g = function (a, b) {
          var f,
            h,
          ...
          if (Array.isArray(a) || a instanceof e) {
            ...
            if (-1 !== a.indexOf(",")) {
              i = a.split(",");
              f = 0;
              for (h = i.length; f < h; f++) g(i[f].trim(), b);
            } else if (a.match(/^\d+(\-\d+)*$/))
              (f = e.map(i, function (a) {
                return a.idx;
              })),
                c.push({ inst: b, node: i[e.inArray(a, f)].node });
            else if (-1 !== a.indexOf(":name")) {
              var n = a.replace(":name", "");
              f = 0;
              for (h = i.length; f < h; f++)
                i[f].name === n && c.push({ inst: b, node: i[f].node });
            } else
              e(f)
                .filter(a)
                .each(function () {
  ...
  n.stripData = function (a, b) {
    ...
    b.decodeEntities && ((A.innerHTML = a), (a = A.value));
    return a;
  };
  n.defaults = {
  ...
  i.Api.register("buttons()", function (a, b) {
    ...
    var c = this.iterator(
      ...
      function (c) {
        if (c._buttons)
          return n.buttonSelector(n.instanceSelector(a, c._buttons), b);
      },
      !0
    );
    c._groupSelector = a;
  ...
  i.Api.register("button().popover()", function (a, b) {
  ...
  i.Api.register("buttons().containers()", function () {
    ...
    this.iterator(!0, "table", function (c) {
      if (c._buttons)
        for (
          var c = n.instanceSelector(b, c._buttons), d = 0, e = c.length;
          d < e;
          d++
        )
  ...
  i.Api.register("button().add()", function (a, b) {
    var c = this.context;
    c.length &&
      ((c = n.instanceSelector(this._groupSelector, c[0]._buttons)),
  ...
  i.Api.register("buttons.info()", function (a, b, c) {
    ...
    if (!1 === a)
      return (
        ...
        x(e("#datatables_buttons_info"), 400, function () {
          e(this).remove();
        }),
        clearTimeout(v),
        (v = null),
      ...
      var b = new i.Api(this.context[0]),
        ...
        d = b.table().footer()
          ? b
              ...
              .toArray()
          : null,
        g = e.extend({}, c.modifier);
      b.select &&
        "function" === typeof b.select.info &&
        g.selected === m &&
        b.rows(c.rows, e.extend({ selected: !0 }, g)).any() &&
        e.extend(g, { selected: !0 });
      for (
        ...
        for (var q = [h], r = 0; r < h; r++)
          (q[r] = c.format.body(g[l], j, r, f[l])), l++;
        k[j] = q;
      }
  ...
  i.Api.register("buttons.exportInfo()", function (a) {
    ...
    b === m || null === b
      ? (b = null)
      : (-1 !== b.indexOf("*") &&
          (b = b.replace("*", e("head > title").text()).trim()),
    ...
    c =
      null === c
        ? null
        : -1 !== c.indexOf("*")
        ? c.replace("*", e("head > title").text() || "")
        : c;
    return {
      filename: b,
      title: c,
      messageTop: B(this, a.message || a.messageTop, "top"),
      messageBottom: B(this, a.messageBottom, "bottom"),
    };
  });
  var y = function (a) {
    ...
    A = e("<textarea/>")[0];
  e.fn.dataTable.Buttons = n;
  e.fn.DataTable.Buttons = n;
  e(q).on("init.dt plugin-init.dt", function (a, b) {
    if ("dt" === a.namespace) {
      var c = b.oInit.buttons || i.defaults.buttons;
      c && !b._buttons && new n(b, c).container();
    }
  });
  i.ext.feature.push({ fnInit: z, cFeature: "B" });
  i.ext.features && i.ext.features.register("buttons", z);
  return n;
});
