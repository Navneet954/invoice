...
<div class="container content-invoice">
		      	...
		      	<div class="row">	
						...
						<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                           ...
                           <label>Order Date</label>
									<input type="date" name="order_date" id="" class="form-control" value="<?php echo $invoiceValues['order_date']; ?>">
								</div>
    ...
    <option value="Cheque"
	<?php
                            if($invoiceValues['p_mode']=='Cheque'){
                                echo "selected";
                            }
                            ?>
	>Cheque</option>
	...
	<?php
                            if($invoiceValues['p_mode']=='Net Banking'){
                                echo "selected";
                            }
                            ?>>Net Banking</option>
    <option value="Debit Card"
	<?php
                            if($invoiceValues['p_mode']=='Debit Card'){
                                echo "selected";
                            }
                            ?>
	>Debit Card</option>
	...
	<?php
                            if($invoiceValues['p_mode']=='Credit Card'){
                                echo "selected";
                            }
                            ?>>Credit Card</option>
	...
	<?php
                            if($invoiceValues['p_mode']=='PhonePe'){
                                echo "selected";
                            }
                            ?>>PhonePe</option>
    <option value="GooglePay"
	<?php
                            if($invoiceValues['p_mode']=='GooglePay'){
                                echo "selected";
                            }
                            ?>
	>GooglePay</option>
	...
	<?php
                            if($invoiceValues['p_mode']=='No Payment'){
                                echo "selected";
                            }
                            ?>
	>No Payment</option>
    ...
    <option value="None"
	<?php
                            if($invoiceValues['b_status']=='None'){
                                echo "selected";
                            }
                            ?>
	>None</option>
    <option value="Billed"
	<?php
                            if($invoiceValues['b_status']=='Billed'){
                                echo "selected";
                            }
                            ?>
	>Billed</option>
    <option value="Non Billed"
	<?php
                            if($invoiceValues['b_status']=='Non Billed'){
                                echo "selected";
                            }
                            ?>
	>Non Billed</option>
